...
# Function to merge existing and new data
def merge_data(existing_data, new_data, update_keys):
...
def incremental_update(engine, csv_file_path, table_name, update_keys):
    ...
    update_keys = update_keys if isinstance(update_keys, list) else [update_keys]
    ...
    if not check_table_exists(engine, table_name):
        ...
        merged_data = merge_data(existing_data, new_data, update_keys)
...
if __name__ == "__main__":
    ...
    csv_files = [
        {'path':'/opt/airflow/data/transform/python/salary_per_hours.csv', 
        'table': 'salary_per_hours_python', 
